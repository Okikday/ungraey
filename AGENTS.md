...
NEVER edit generated code. The server's `lib/src/generated/` directory and the whole `ungraey_client` package are rewritten by the code generator. Change the `.spy.yaml` models, the endpoints, or `lib/server.dart` instead.
