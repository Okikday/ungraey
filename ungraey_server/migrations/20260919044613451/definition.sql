...
--
-- Class EcoImpact as table eco_impact
--
...
--
-- Class HandoffTransaction as table handoff_transaction
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('ungraey', '20260919044613451', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260919044613451', "timestamp" = now();
